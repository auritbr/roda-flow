...
export const GALLERY = [
  ...
  { year: "2023", title: "Roda comunitária de aniversário", date: "Data a informar", image: "https://images.unsplash.com/photo-1759352856072-985a4ddab82d?auto=format&fit=crop&w=1600&q=80", alt: "Roda coletiva de Capoeira", caption: "Celebração de aniversário do Ponto de Cultura.", credit: "Crédito a informar", category: "Roda de Capoeira" },
  { year: "2023", title: "Vivência com famílias", date: "Data a informar", image: "https://images.unsplash.com/photo-1653476597388-b9a2d5f688d6?auto=format&fit=crop&w=1600&q=80", alt: "Famílias participando de atividade", caption: "Atividade voltada às famílias do território.", credit: "Crédito a informar", category: "Comunidade" },
];
